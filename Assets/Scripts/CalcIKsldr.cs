...
public class CalcIKsldr : MonoBehaviour
{
    ...
    public int[] position;
    public InputField S_Slider;    //PositionX min=4 max=12
    public InputField L_Slider;    //PositionY min=-4 max=4
    public InputField U_Slider;    //PositionZ min=4 max=12
    ...
    void Update()
    {
        ...
        px = float.Parse(S_Slider.text);
        py = float.Parse(L_Slider.text);
        pz = float.Parse(U_Slider.text);
        rx = R_Slider.value;
        ry = B_Slider.value;
        rz = T_Slider.value;
